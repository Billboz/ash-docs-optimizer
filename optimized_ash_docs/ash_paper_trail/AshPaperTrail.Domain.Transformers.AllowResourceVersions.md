# AshPaperTrail.Domain.Transformers.AllowResourceVersions — ash_paper_trail v0.1.4

Project: ash_paper_trail v0.1.4

## Table of Contents

- [ __ View Source ](external_link) AshPaperTrail.Domain.Transformers.AllowResourceVersions (ash_paper_trail v0.1.4)
- __ Summary
  - Functions
- __ Functions
- after?(_)
