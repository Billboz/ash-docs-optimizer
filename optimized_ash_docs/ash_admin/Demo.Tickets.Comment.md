# Demo.Tickets.Comment — ash_admin v0.11.5

Project: ash_admin v0.11.5

## Table of Contents

- [ __ View Source ](external_link) Demo.Tickets.Comment (ash_admin v0.11.5)
- __ Summary
  - Types
  - Functions
- __ Types
...
[ __ View Source ](external_link)
    ...
    @type t() :: %Demo.Tickets.Comment{
      ...
      comment: [term](external_link)(),
      commenting_customer: [term](external_link)(),
      commenting_customer_id: [term](external_link)(),
      commenting_representative: [term](external_link)(),
      commenting_representative_id: [term](external_link)(),
      id: [term](external_link)(),
      resource_id: [term](external_link)()
    }
